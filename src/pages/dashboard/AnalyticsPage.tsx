...
const EquityCurve = () => {
  ...
  return (
    <svg viewBox="0 0 600 160" className="w-full h-40">
      ...
      <path d={path} fill="none" stroke="hsl(152,69%,53%)" strokeWidth="2" />
    </svg>
  );
};
                ...
                <div key={m.month} className="flex items-center gap-3">
                  ...
                  <div className="flex-1 h-8 bg-secondary/50 rounded-lg overflow-hidden relative">
                    <div
                      ...
                      style={{ width: `${(Math.abs(m.pnl) / maxPnl) * 100}%` }}
                    />
                  </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="text-muted-foreground border-b border-border">
                  ...
                  <th className="text-left pb-3 font-medium">Exit</th>
              ...
              <tbody>
                {tradeHistory.map((t, i) => (
                  <tr key={i} className="border-b border-border/50 last:border-0">
                    ...
                    <td className="py-3">{t.entry}</td>
                    <td className="py-3">{t.exit}</td>
