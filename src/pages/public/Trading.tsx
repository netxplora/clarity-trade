...
export default function Trading() {
  ...
  return (
    <PublicLayout title="Trading Platform">
      ...
      />
      <div className="container px-4 md:px-6 max-w-6xl mx-auto py-24 text-foreground">
        <div className="text-center max-w-3xl mx-auto mb-20">
          <h2 className="text-3xl font-display font-black text-foreground mb-6 uppercase tracking-tight">Built for the Pros</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-24">
           {features.map((f, i) => (
              ...
              >
                 ...
                 <h3 className="text-2xl font-bold font-display text-foreground mb-3 uppercase tracking-tight">{f.title}</h3>
        ...
        <section className="py-24 bg-background mb-24 rounded-[3rem] border border-border shadow-sm overflow-hidden">
            <div className="container mx-auto px-6">
                <div className="text-center max-w-2xl mx-auto mb-16">
                    <span className="heading-gold">Multi-Asset Ecosystem</span>
                    <h2 className="title-hyip text-foreground leading-tight">A Single Account for <span className="text-[#D4AF37]">Global Markets</span></h2>
                </div>
                <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    {[
                        ...
                        <div key={asset.title} className="p-10 rounded-[2.5rem] bg-gray-50 border border-gray-100 group hover:bg-background hover:shadow-huge transition-all">
                            ...
                            <p className="text-sm text-muted-foreground leading-relaxed font-medium">{asset.desc}</p>
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center mb-24">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="lg:w-1/2 space-y-8">
                ...
                <h2 className="text-4xl lg:text-5xl font-display font-black text-foreground leading-tight uppercase">Surgical Precision in <span className="text-primary underline underline-offset-8 decoration-gold/30">Every Order</span></h2>
                <div className="space-y-6">
                    {[
                        ...
                        <div key={item.title} className="p-6 rounded-2xl bg-background border border-border group hover:border-primary/30 transition-all">
            ...
            <div className="lg:w-1/2 relative">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="space-y-4 pt-8">
                        <div className="bg-background p-8 rounded-3xl border border-border shadow-huge">
                            <div className="text-3xl font-black text-foreground mb-1">99.99%</div>
           ...
           <div className="rounded-[1.5rem] overflow-hidden bg-background aspect-video border border-white/10 shadow-huge relative flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: "url('/images/hero-trading-bg.png')" }}>
              ...
              <div className="text-center relative z-10 px-4">
                 ...
                 <div className="flex flex-col sm:flex-row gap-6 justify-center">
                    ...
                    <Button variant="outline" className="h-14 px-12 text-lg bg-transparent text-white border-white/20 hover:bg-background/10 rounded-xl uppercase font-bold tracking-widest" asChild>
