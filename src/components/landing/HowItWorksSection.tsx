        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto items-start">
          {steps.map((step, i) => (
            <motion.div
              ...
              className="relative p-8 rounded-xl bg-card border border-border hover:border-[#D4AF37]/50 transition-colors group h-full flex flex-col items-center text-center"
            >
              ...
              <div className="w-16 h-16 rounded-full bg-secondary border border-border flex items-center justify-center mb-6 relative z-10 group-hover:border-[#D4AF37] transition-all">
