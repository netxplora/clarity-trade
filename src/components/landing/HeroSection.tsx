        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-1/2">
            ...
            >
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-secondary border border-border mb-6">
                ...
                <span className="text-sm font-medium text-muted-foreground">Fast & Secure Trading Platform</span>
              </div>
              
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-foreground leading-tight mb-6" style={{ fontFamily: "Inter, sans-serif" }}>
                Professional Asset Management & <span className="text-[#D4AF37]">Copy Trading Platform</span>
              </h1>
              
              <p className="text-lg md:text-xl text-muted-foreground mb-10 leading-relaxed max-w-xl" style={{ fontFamily: "Inter, sans-serif" }}>
              ...
              <div className="flex flex-wrap gap-4">
                {user ? (
                  ...
                  <>
                    ...
                    <Link to="/copy-trading" className="flex items-center gap-2 px-8 py-4 bg-transparent text-foreground border border-border hover:border-[#D4AF37] hover:text-[#D4AF37] transition-colors rounded font-bold text-sm uppercase tracking-widest">
              ...
              <div className="flex flex-wrap items-center gap-6 mt-12 pt-8 border-t border-border/50">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium text-muted-foreground">Secure Assets</span>
                </div>
                <div className="flex items-center gap-2">
                  <Zap className="w-5 h-5 text-[#D4AF37]" />
                  <span className="text-sm font-medium text-muted-foreground">Instant Execution</span>
                </div>
                <div className="flex items-center gap-2">
          ...
          <div className="lg:w-1/2 relative">
            <motion.div
              ...
              className="relative z-10 rounded-2xl overflow-hidden border border-border shadow-2xl shadow-[#D4AF37]/5"
            >
            ...
            <motion.div
              ...
              className="absolute -bottom-6 -left-6 z-20 bg-card border border-border p-4 rounded-xl shadow-xl flex items-center gap-4"
            >
              <div className="w-12 h-12 rounded-full bg-[#D4AF37]/10 flex items-center justify-center">
                <TrendingUp className="w-6 h-6 text-[#D4AF37]" />
              </div>
              <div>
                <p className="text-sm text-muted-foreground font-medium">Monthly Return</p>
                <p className="text-xl font-bold text-foreground">+14.2%</p>
              </div>
            </motion.div>
          </div>
