    ...
    <section className="py-8 bg-background border-t border-border/50">
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          <h4 className="text-xs font-bold text-muted-foreground/60 uppercase tracking-widest mb-3" style={{ fontFamily: "Inter, sans-serif" }}>
            Risk Disclaimer & Regulatory Notice
          </h4>
          <p className="text-[10px] sm:text-xs text-muted-foreground/50 leading-relaxed text-justify mb-3">
          ...
          <p className="text-[10px] sm:text-xs text-muted-foreground/50 leading-relaxed text-justify">
