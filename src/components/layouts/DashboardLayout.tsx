...
import {
  ...
  LogOut, TrendingUp, Menu, X, Bell, ChevronDown,
} from "lucide-react";
    ...
    <>
      ...
      <div className="p-3 border-t border-border">
        <Link
          to="/login"
          onClick={onNavigate}
          className="flex items-center gap-3 px-4 py-3 rounded-lg text-sm text-muted-foreground hover:text-foreground hover:bg-accent transition-all"
        >
